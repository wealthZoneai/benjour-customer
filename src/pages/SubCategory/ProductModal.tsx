    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white rounded-3xl max-w-3xl w-full shadow-2xl
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 text-sm space-y-1">
                  <p><b>Unit:</b> {unitLabel}</p>
                  <p><b>Min Qty:</b> {selectedProduct.minValue}</p>
                  <p><b>Max Qty:</b> {selectedProduct.maxValue}</p>
                </div>
                ...
                <button
                  ...
                  disabled={isAdding}
                  className="w-full mt-6 bg-gradient-to-r from-emerald-600 to-emerald-700
                ...
                <div className="flex gap-4 overflow-x-auto pb-2">
                  {relatedProducts.map((item) => (
                    <div
                      ...
                      className="min-w-[160px] cursor-pointer bg-gray-50 hover:bg-gray-100 p-3 rounded-xl transition"
                    >
                      <img
                        src={item.imageUrl}
